...
\ *P \b----- Display definitions used when the analyzer is ON. -----\d\n
\ ** (See Analyze:)
: .JobStatus ( &JobEntry - )
...
:M ClassInit:  ( -- )
\ *G Initializes the object. Happens automaticly when Forth or a turnkey is starts.
...
TIMER-RESET
value-ft0 ft0 f>s 3 * .s value  #counts   \ To get a runtime for about 8 - 20 seconds
...
: .Analyse#Counts  ( - )
    ...
    cr ." Total counts: " #counts s>f GetThreadcount: myTasks s>f f* fdup e.
    s>f  1000e  f/
...
All tasks ended. Elapsed time: 00:00:07.158
Total counts: 1.50083E9
counts / second: 209.672E6

Main task is waiting for 4 tasks
All tasks ended. Elapsed time: 00:00:08.988
Total counts: 6.00334E9
counts / second: 667.928E6     3.18558E0 Times faster

Main task is waiting for 7 tasks
All tasks ended. Elapsed time: 00:00:12.677
Total counts: 1.05058E10
counts / second: 828.733E6     3.95251E0 Times faster

Main task is waiting for 8 tasks
All tasks ended. Elapsed time: 00:00:14.406
Total counts: 1.20067E10
counts / second: 833.450E6     3.97501E0 Times faster

Main task is waiting for 12 tasks
All tasks ended. Elapsed time: 00:00:21.912
Total counts: 1.80100E10
counts / second: 821.925E6     3.92004E0 Times faster
End of demo.  ))
